...
class AppServerExecutor:
    ...
    def start_file_transfer_server(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if result['success']:
                ...
                self.logger.error(f"Failed to start file transfer server: {result['error']}")
                
            return result
            
        except Exception as e:
            self.logger.error(f"Exception during file transfer server startup: {e}")
            return {
                'success': False,
                'error': str(e),
                'pid': None,
    ...
    def stop_file_transfer_server(self) -> Dict[str, Any]:
        ...
        try:
            ...
            self.logger.error(f"Exception during file transfer server cleanup: {e}")
    ...
    def start_file_transfer_pmec_server(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if result['success']:
                self.logger.info("File transfer PMEC server started successfully")
                self.logger.info(f"Session name: {result.get('session_name', 'N/A')}")
            else:
                self.logger.error(f"Failed to start file transfer PMEC server: {result['error']}")
                
            return result
            
        except Exception as e:
            self.logger.error(f"Exception during file transfer PMEC server startup: {e}")
            return {
                'success': False,
                'error': str(e),
                'pid': None,
    ...
    def stop_file_transfer_pmec_server(self) -> Dict[str, Any]:
        ...
        try:
            ...
            self.logger.error(f"Exception during file transfer PMEC server cleanup: {e}")
            return {'success': False, 'error': str(e)}
    ...
    def start_video_transcoding_server(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if result['success']:
                self.logger.info("Video transcoding server started successfully")
                self.logger.info(f"Session name: {result.get('session_name', 'N/A')}")
            else:
                self.logger.error(f"Failed to start video transcoding server: {result['error']}")
                
            return result
            
        except Exception as e:
            self.logger.error(f"Exception during video transcoding server startup: {e}")
            return {
                'success': False,
                'error': str(e),
                'pid': None,
    ...
    def stop_video_transcoding_server(self) -> Dict[str, Any]:
        ...
        try:
            ...
            self.logger.error(f"Exception during video transcoding server cleanup: {e}")
            return {'success': False, 'error': str(e)}
    ...
    def start_video_transcoding_pmec_server(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if result['success']:
                self.logger.info("Video transcoding PMEC server started successfully")
                self.logger.info(f"Session name: {result.get('session_name', 'N/A')}")
            else:
                self.logger.error(f"Failed to start video transcoding PMEC server: {result['error']}")
                
            return result
            
        except Exception as e:
            self.logger.error(f"Exception during video transcoding PMEC server startup: {e}")
            return {
                'success': False,
                'error': str(e),
                'pid': None,
    ...
    def stop_video_transcoding_pmec_server(self) -> Dict[str, Any]:
        ...
        try:
            ...
            result['success'] = True
            self.logger.info("Video transcoding PMEC server stopped successfully")
            return result
            
        except Exception as e:
            self.logger.error(f"Exception during video transcoding PMEC server cleanup: {e}")
            return {'success': False, 'error': str(e)}
